...
- [ ] 5.5 Confirm the backlog reflects the promotion — `docs/agent/backlog/features/f1-estimation-progress-narration.md` carries `Status: promoted → openspec/changes/2026-08-20-narrate-estimation-progress`, and `docs/agent/backlog/features/README.md` no longer lists it under open feature requests. Done when the proposal was written; no edit expected.
