...
Provide the user's daily calorie goal and macronutrient split, and the derived per-macro gram targets that the day nutrition score is measured against. Ships sensible defaults so scoring works before any configuration.
